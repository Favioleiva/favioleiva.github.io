...
<audio controls>
  <source src="{{ \'/audio/1madreypadre.mp3\' | relative_url }}" type="audio/mpeg">
</audio>

<img src="{{ \'/images/Faviocon.jpg\' | relative_url }}" alt="Faviocon" style="width: 100%; height: auto; max-width: 600px;">
